          ...
          <SideForm>
              ...
              <div>
                <div className="margin-bottom-15">
                  <Field
                    ...
                    onEmptyDocument={() =>
                      change("moduleTextGallery", "background.object", {})
                    }
                    clearBbox={() =>
                      this.props.change(
                        "moduleTextGallery",
            ...
            <div className="margin-bottom-15">
              <FormGroup>
                ...
                <Field name="gallery.layout" component={Select}>
            ...
            <div className="margin-bottom-15">
              <FieldArray
                ...
                params={{ filters: { type__in: ["image", "pdf"] } }}
              />
            </div>
          </SideForm>
          <SideActions>
        ...
        >
          ...
          <div className="ModuleFormTextGallery__GalleryContainer">
            ...
            <div className="ModuleFormTextGallery__DocumentPreview__Caption">
              ...
              />
              <Field name={`gallery.caption`} component={Translate} />
            </div>
          </div>
        </PreviewContainer>
      </VisualForm>
...
const getImages = defaultMemoize(objects =>
  objects.map(o =>
    o.id.data.resolutions ? o.id.data.resolutions.medium.url : ""
  )
);
