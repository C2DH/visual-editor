...
export const LoginRoute = { to: '/login', path: 'login', label: 'navigationLogin' }
export const SettingsRoute = { to: '/settings', path: 'settings', label: 'navigationSetting' }
export const StoriesRoute = { to: '/stories', path: 'stories', label: 'navigationStories' }
export const DocumentsRoute = { to: '/docs', path: 'docs', label: 'navigationDocuments' }
export const NotFoundRoute = { to: '/pages/not-found', label: 'navigationNotFound' }
